...
RSpec.describe "the is_multiple_of_3_or_5? method" do
...
RSpec.describe "the sum_of_3_or_5_multiples method" do

  it "should return the sum of multiples (including zero if applicable)" do
